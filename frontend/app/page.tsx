...
const TIERS = [
  {
    ...
    features: ["10 analyses / month", "Charts & summaries", "1 dataset at a time"],
    cta: "Start free",
    highlighted: false,
  },
  {
    ...
    features: ["300 analyses / month", "Full reports & exports", "Hypothesis / project tracking", "Priority model routing"],
    cta: "Get Pro",
    highlighted: true,
  },
]
